...
.side-text-cont {
  transform: rotate(0.25turn) translate(60%,600%);
  height: auto;
  width: 350px;
}
.landing-vert-text{
...
.content-cont{
  float:left;
  margin: clamp(30px, 15vw, 75px) clamp(1px, 5vw, 50px) 20px;
  width: auto;
}
.right-cont{
  float:left;
...
.landing-text-cont{
  margin-left: clamp(30px, 4vw, 300px);
...
.landing-sub-text{
  ...
  color: var(--pure-white);
  text-align: left;
  font: var(--primary-font-style-normal) normal 100 21px var(--primary-font-family-proxima-nova);
